...
class KGCN(object):
    ...
    def _build_inputs(self):
        ...
        self.data_weights = tf.placeholder(dtype=tf.float32, shape=[None], name='data_weights')
    ...
    def _build_model(self, n_user, n_entity, n_relation):
        ...
        # self.data_weights = tf.expand_dims(self.data_weights, axis=1)
        # [batch_size]
        self.scores = tf.reduce_sum(self.user_embeddings * self.item_embeddings, axis=1) * self.data_weights
